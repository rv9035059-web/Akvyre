    ...
    <PageShell>
      ...
      <section className="pb-0">
        <div className="max-w-shell mx-auto px-6 md:px-12">
          ...
          {/* Full-width premium reviews cards row filling the empty space perfectly */}
          <div className="pt-12 md:pt-16 pb-0">
            <Reveal delay={100}>
              <div className="review-ratings-grid" style={{ marginTop: 0 }}>
                {/* Trustpilot Card */}
                <a 
                  href="https://www.trustpilot.com" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="review-rating-card"
                >
                  <div>
                    <div className="review-card-header">
                      ...
                      <span className="review-logo-text">Trustpilot</span>
                    </div>
                    ...
                    <div className="review-card-body">
                      We're rated <strong>Excellent</strong> on Trustpilot.
                    </div>
                  </div>
                  <div>
                    <span className="review-card-link">check out our reviews</span>
                  </div>
                </a>
                ...
                >
                  <div>
                    <div className="review-card-header">
                      ...
                      <span className="review-logo-text" style={{ marginLeft: "2px" }}>Google</span>
                    </div>
                    <div className="review-stars-row">
                      {[...Array(5)].map((_, i) => (
                        <svg key={i} viewBox="0 0 24 24">
                    ...
                    <div className="review-card-body">
                      We're rated <strong>4.9/5 stars</strong> on Google.
                    </div>
                  </div>
                  <div>
                    <span className="review-card-link">check out our reviews</span>
                ...
                >
                  <div>
                    <div className="review-card-header" style={{ gap: "4px" }}>
                      <span className="review-logo-text" style={{ fontSize: "16px", fontWeight: 800, marginRight: "2px" }}>4.9</span>
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#00b67a" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" style={{ transform: "translateY(-1px)" }}>
                        <polyline points="20 6 9 17 4 12" />
                      </svg>
                      <span className="review-logo-text" style={{ fontSize: "11px", fontWeight: 500, letterSpacing: "-0.01em" }}>review<span style={{ color: "var(--bone-dim)" }}>solicitors</span></span>
                    </div>
                    <div className="review-stars-row">
                      {[...Array(5)].map((_, i) => (
                        <svg key={i} viewBox="0 0 24 24">
                    ...
                    <div className="review-card-body">
                      We're rated <strong>4.9 stars</strong> on ReviewSolicitors.
                    </div>
                  </div>
                  <div>
                    <span className="review-card-link">check out our reviews</span>
